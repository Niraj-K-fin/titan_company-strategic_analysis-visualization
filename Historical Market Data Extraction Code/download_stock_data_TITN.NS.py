...
ticker_symbol = "TITAN.NS" # Change ticker_symbol to "^NSEI" for NIFTY 50

start_date = "2015-04-01"
end_date = "2025-03-31"

print("Downloading Monthly Historical Data for Titan...")
try:
    ...
    if not monthly_data.empty:
        ...
        monthly_data.to_csv('titan_monthly_data.csv')
